...
public class ColorToRegNumberCommandExecutor extends CommandExecutor {
    public final static String COMMAND_NAME = "registration_numbers_for_cars_with_colour";
    ...
    public void execute(Command command) {
        ...
        for (ParkingSlot parkingSlot : slotList) {
            outputPrinter.printWithNewLine(parkingSlot.getParkedCar().getRegistrationNumber());
        }
    }
}
